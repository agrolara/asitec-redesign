...
('pasteler-a-22', 'Brillo Gel Frío, marca Springel, España', 'Pastelería', 'Productos Importados Pastelería', 'Brillo gel frío, especial para aplicar en tartaletas, masas dulces y postres.', 'Balde de 6 Kg', '12 meses a partir de la fecha de elaboración. Conservar en un lugar fresco, seco, limpio y envase cerrado.', 'Chile', 'https://www.asitec.cl/wp-content/uploads/2021/06/springel.jpg', 0, 'https://www.asitec.cl/linea-de-productos-pasteleria-importados/'),
('pasteler-a-23', 'Premezcla Eclair, España', 'Pastelería', 'Productos Importados Pastelería', 'Premezcla para elaborar Eclair, Masa Choux y/o Repollitos.', 'Saco de 10 Kg', '06 meses a partir de la fecha de elaboración. Conservar en un lugar fresco, seco, limpio y envase cerrado.', 'Chile', 'https://www.asitec.cl/wp-content/uploads/2021/06/eclair-asitec.jpg', 0, 'https://www.asitec.cl/linea-de-productos-pasteleria-importados/'),
...
-- --------------------------------------------------------
-- 4. Tabla de Equipos de Laboratorio y Molinos SAG
-- --------------------------------------------------------
...
CREATE TABLE `equipments` (
  ...
  `description` text NOT NULL,
  `specs` text NOT NULL,
  `sag_certified` tinyint(1) NOT NULL DEFAULT 1,
  `image` text DEFAULT '',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
INSERT INTO `equipments` (`id`, `name`, `brand`, `model`, `tagline`, `description`, `specs`, `sag_certified`, `image`) VALUES
('bastak-c4000', 'Molino Experimental de Laboratorio Mill C-4000', 'Bastak', 'C-4000', 'El equipo analítico más vendido en Chile, registrado en SAG', 'Apto para molienda de grano seco como húmedo. Separa automáticamente harina y salvado en contenedores independientes tras pasar por rodillos calibrados. Posee frontal de vidrio para inspección y prevención de contaminación cruzada.', '["Porcentaje de extracción: 50% a 60% según calidad del trigo","Molienda regulable mediante ajuste micrométrico de alimentación","Frontal de vidrio templado para fácil aseo y visualización en tiempo real","Transmisión por correas en V antitrancado","Dimensiones: 300 x 600 x 560 mm | Peso: 42 Kg","Incluye tamiz con tela calibrada 9XX a medida"]', 1, 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&q=80'),
('glutomatic', 'Sistema Glutomatic Integral', 'Perten / Analytical', 'Glutomatic System', 'Determinación oficial de cantidad y calidad de gluten en harinas', 'Consta de 3 módulos de alta precisión: el primer módulo lava la muestra eliminando proteínas hidrosolubles para calcular proteína de gluten; el segundo mide el índice de tenacidad (Gluten Index); y el tercer módulo es un secador de precisión para gluten seco.', '["Determinación de Gluten Húmedo, Seco y Gluten Index (Tenacidad)","Lavado automatizado con solución salina estandarizada","Centrífuga de tamiz de precisión para separación de fracciones","Secador térmico directo libre de residuos","Cumple normas internacionales ICC 137/1, 155, 158 e ISO 21415"]', 1, 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=800&q=80'),
('enzinumber', 'Analizador de Actividad Enzimática Enzinumber', 'Enzinumber Tech', 'FN-System', 'Medición rápida y certera del Falling Number (Índice de Caída)', 'Evalúa la actividad enzimática de alfa-amilasas en soluciones de harina sometidas a temperatura de ebullición. Esencial para graduar mezclas en molinos y panaderías.', '["Rango óptimo estandarizado: ~250 segundos","Detección de déficit amilásico: >330 segundos","Detección de sobrecarga enzimática: ~220 segundos","Control microprocesado de temperatura de baño María a 100°C","Agitación e inmersión mecánica automatizada de doble cabezal"]', 1, 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?auto=format&fit=crop&w=800&q=80'),
('termobalanza-honeywell', 'Termobalanza de Alta Temperatura Honeywell', 'Honeywell Analytics', 'TB-1000', 'Determinación continua de humedad, calcinación y cenizas', 'Horno termobalanza de precisión operativa entre 40°C y 1000°C con termocupla NiCr-Ni y cerebro electrónico Honeywell. Capaz de operar 100 horas continuas.', '["Rango térmico: 40°C a 1000°C con sensibilidad de termostato de 1°C","Termocupla industrial NiCr-Ni para alta reproducibilidad","Unidad electrónica digital Honeywell de servicio continuo (100 hrs)","Alimentación: 220V 50Hz, potencia 1.5 kW | Volumen útil: 3 dm³","Dimensiones interiores: 140 x 110 x 200 mm | Exteriores: 320 x 410 x 350 mm | Peso: 20 Kg","Garantía de 1 año y 10 años de disponibilidad en piezas de recambio"]', 1, 'https://images.unsplash.com/photo-1581093458791-9f3c3900df4b?auto=format&fit=crop&w=800&q=80'),
('calador-granos', 'Calador de Granos Acero Inoxidable 304', 'Asitec Industrial', 'CG-170', 'Muestreo estratificado de trigo en camiones tolva y graneleros', 'Herramienta de precisión construida en acero inoxidable AISI 304 con fina terminación. Con 1.70 metros y 11 celdas independientes para muestreos homogéneos a diferentes profundidades.', '["Largo total: 1.70 metros con 11 celdas de muestreo de 85 x 25 mm","Fabricado en Acero Inoxidable 304 de grado alimentario","Manillar en acero calidad 1020 con empuñaduras plásticas antideslizantes","Punta cónica de aluminio desmontable para penetración suave en tolva","Peso liviano balanceado: 4.2 Kg para manipulación ágil en terreno"]', 1, 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?auto=format&fit=crop&w=800&q=80'),
('cernidor-laboratorio', 'Equipo Cernidor Microprocesado de Laboratorio', 'Bastak Lab', 'Sieve-Pro 8', 'Análisis granulométrico y homogeneidad de partículas en polvo', 'Equipo electromecánico con timer y apagado automático controlado por microprocesador. Permite estandarizar la distancia de rodillos en molienda y verificar tamices en la producción diaria.', '["Control microprocesado con temporizador y apagado automático","Set de 8 aros de PVC de alta duración más contenedor y tapa de aluminio","Mallas calibrables intercambiables según requerimiento del cliente","Apto para harinas, almidones, premezclas, minerales y agregados sólidos"]', 1, 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80');
...
('crema-chantilly', 'Crema Chantilly Perfecta', 'Pastelería', '5 min', 'Fácil', 'https://www.asitec.cl/wp-content/uploads/2024/05/Crema-chantilly.mp4', 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=600&q=80', 'Aprende a preparar y batir Crema Chantilly con volumen estable, textura tersa y sin desuerar, ideal para decoraciones finas.', 'Base Crema Chantilly Asitec', '["Disolver la base Chantilly en leche o agua fría (4°C a 6°C).","Batir a velocidad media durante 1 minuto para homogenizar.","Aumentar a velocidad máxima por 3 a 4 minutos hasta obtener picos firmes.","Refrigerar 15 minutos antes de manguear."]'),
('brownie-fudge', 'Brownie Americano Crocante y Húmedo', 'Pastelería', '25 min', 'Fácil', 'https://www.asitec.cl/wp-content/uploads/2024/05/Brownie.mp4', 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=600&q=80', 'Elaboración de Brownie estilo fudge con costra craquelada brillante y centro chocolatoso denso y húmedo.', 'Premezcla Brownie Asitec', '["Mezclar la Premezcla Brownie con agua y materia grasa según dosificación.","Batir en primera velocidad por 2 minutos hasta integrar sin sobrebatir.","Verter en bandeja con papel mantequilla o desmoldante.","Hornear a 180°C durante 22 a 25 minutos. Enfriar completamente antes de cortar."]'),
('queque-vainilla-chocolate', 'Queque Marmolado Vainilla y Chocolate', 'Pastelería', '40 min', 'Intermedio', 'https://www.asitec.cl/wp-content/uploads/2024/05/queque-vainilla-chocolate.mp4', 'https://images.unsplash.com/photo-1549576490-b0b4831ef60a?auto=format&fit=crop&w=600&q=80', 'Combinación armoniosa de queque esponjoso sabor vainilla con vetas de chocolate belga.', 'Premezclas Queques Asitec', '["Elaborar el batido base con Premezcla Queque Vainilla, huevos, aceite y agua.","Dividir una porción del batido e incorporar cacao puro.","Alternar capas en el molde y generar efecto marmolado con espátula.","Hornear a 170°C por 35-40 minutos."]'),
('bizcocho-vainilla', 'Bizcocho Clásico de Gran Volumen', 'Pastelería', '30 min', 'Fácil', 'https://www.asitec.cl/wp-content/uploads/2024/05/bizcocho-vainilla.mp4', 'https://images.unsplash.com/photo-1535141192574-5d4897c13136?auto=format&fit=crop&w=600&q=80', 'Técnica profesional para brazos de reina, empolvados y tortas tradicionales con miga ligera y aireada.', 'Premezcla Bizcocho Vainilla Asitec', '["Incorporar huevos y agua a la Premezcla Bizcocho Asitec.","Batir a velocidad alta durante 8 a 10 minutos para máxima aireación.","Dosificar en moldes circulares o bandejas para brazo de reina.","Hornear a 190°C por 18 a 22 minutos."]'),
('muffins-gourmet', 'Muffins con Copete Gourmet', 'Pastelería', '25 min', 'Fácil', 'https://www.asitec.cl/wp-content/uploads/2024/05/muffins.mp4', 'https://images.unsplash.com/photo-1586985289688-ca3cf47d3e6e?auto=format&fit=crop&w=600&q=80', 'Muffins de gran desarrollo vertical, corona agrietada dorada y miga excepcionalmente suave.', 'Premezcla Muffins Vainilla Asitec', '["Mezclar Premezcla Muffins con huevos, aceite y agua.","Opcional: incorporar chips de chocolate, arándanos o nueces.","Dosificar en cápsulas de papel llenando al 80% de capacidad.","Hornear a 190°C durante 20 minutos."]'),
('masas-dulces', 'Masas Dulces Tradicionales y Facturas', 'Pastelería', '45 min', 'Intermedio', 'https://www.asitec.cl/wp-content/uploads/2024/05/masas-dulces.mp4', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=600&q=80', 'Preparación de trenzas, berlinesas, rollos de canela y donas con miga hilada de excelente conservación.', 'Premezcla Masas Dulces Asitec', '["Amasar hasta lograr punto de velo o elasticidad completa.","Formar piezas y fermentar en cámara a 30°C con 75% de humedad.","Hornear o freír según la preparación deseada.","Rellenar con Crema Pastelera Asitec."]');
