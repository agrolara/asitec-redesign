...
export const ContactSection: React.FC = () => {
  return (
    <section id="contacto" className="py-20 bg-slate-50 border-b border-slate-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium">Casa Matriz Maipú & Laboratorio SAG</p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-xs text-amber-600 hover:underline font-semibold flex items-center gap-1 mt-0.5"
                    >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="font-bold text-slate-900 hover:text-amber-600 text-base"
                    >
            ...
            <div className="mt-8 pt-4 border-t border-slate-100 flex items-center gap-2 text-xs text-slate-500">
              ...
              <span>Instalaciones industriales con acreditación SAG y control sanitario HACCP.</span>
            </div>
          </div>

          {/* Plant Visual Photo Card */}
          <div className="lg:col-span-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm relative group bg-slate-900">
            <img 
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white space-y-1.5">
              <span className="text-[11px] font-bold text-amber-400 uppercase tracking-widest bg-slate-950/80 px-2.5 py-1 rounded">
                Planta Productiva & Laboratorio
              </span>
